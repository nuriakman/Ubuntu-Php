...
```bash
  ...
  $ sudo apt install php7.2 php-mbstring php7.2-mbstring libapache2-mod-php7.2 php7.2-mysql php-common php7.2-cli php7.2-common php7.2-json php7.2-opcache php7.2-readline
